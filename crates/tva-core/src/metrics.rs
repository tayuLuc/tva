...
#[must_use]
pub fn compute_summary(metrics: &[FrameMetric], tear_count: u64, tear_suppressed: u64) -> SummaryMetrics {
    let n = metrics.len();
    if n == 0 {
        return SummaryMetrics {
            ...
            duplicate_count: 0,
            tear_count,
            tear_suppressed_count: tear_suppressed,
        };
    }
